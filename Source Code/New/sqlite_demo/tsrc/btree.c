...
//Split POINT EXPERIMENT
#define SPLIT_BIAS 50   /* 50 = balanced, 90 = right-heavy */
...
//  /* APPLY SPLIT BIAS HERE */
//  int total = szLeft + szRight;
//  int targetLeft = (SPLIT_BIAS * total) / 100;

//  /* Adjust left/right sizes toward bias */
//  if( szLeft < targetLeft ){
//    int shift = targetLeft - szLeft;
//    if( shift > szRight ) shift = szRight;
//    szLeft += shift;
//    szRight -= shift;
//  }else{
//    int shift = szLeft - targetLeft;
//   if( shift > szLeft ) shift = szLeft;
//   szLeft -= shift;
//    szRight += shift;
//  }
